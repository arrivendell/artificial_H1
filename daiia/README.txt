...
there are 5 secs of delay before the first action that will involve you.
...
Two things will then appear : a notification that an agent has register a service we subscribed to, and this agent will now appear the next time you will have to choose in the list of agents.

These steps show that the Homework is working !
