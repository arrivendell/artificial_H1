...
public class ControllerMobileAuctioneerAgent extends GuiAgent {
// --------------------------------------------
   ...
   private int command;
   transient protected ControllerMobileAuctioneerAgentGui myGui;
...
// ------------------------
      ...
      myGui = new ControllerMobileAuctioneerAgentGui(this, locations.keySet());
...
// ----------------------------------------
	  ...
	  if (command == NEW_AGENT) {
         ...
         try {
            ...
            a = home.createNewAgent(name, MobileAuctioneerAgent.class.getName(), args);
	        a.start();
	        agents.add(name);
