...
public class ControllerMobileAuctioneerAgentGui extends JFrame implements ActionListener {
// -----------------------------------------------------------------------
   ...
   private ControllerMobileAuctioneerAgent myAgent;

   public ControllerMobileAuctioneerAgentGui(ControllerMobileAuctioneerAgent a, Set s) {
// -------------------------------------------------------
